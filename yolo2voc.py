...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_txt_path', type=str, default="/home/data/zhangxin/NWPU_VHR-10/labels")
    parser.add_argument('--source_img_path', type=str, default="/home/data/zhangxin/NWPU_VHR-10/images")
    parser.add_argument('--save_xml_path', type=str, default="/home/data/zhangxin/NWPU_VHR-10/voc_form/annotations")
